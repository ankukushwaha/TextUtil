    ...
    <footer className={`bg-${props.mode} text-center  text-${props.mode === 'light'? 'dark' : 'light'} `}>
      ...
      <div className='container mt-2'>
        ...
        <section className='container'>
          ...
          <Link className="btn text-white btn-floating m-1" style={{ backgroundColor: "#55acee" }} to="https://twitter.com/home" target="_blank" role="button"><i className="fab fa-twitter"></i></Link>

          {/* <a className="btn text-white btn-floating m-1" style={{ backgroundColor: "#dd4b39" }} to="#!" role="button"><i className="fab fa-google"></i></a> */}

          <Link className="btn text-white btn-floating m-1" style={{ backgroundColor: "#ac2bac" }} to="https://www.instagram.com/" target="_blank" role="button"><i className="fab fa-instagram"></i></Link>
